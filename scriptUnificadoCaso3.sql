...
('Registrar votantes', 'REG_VOTER'),('Comentar propuestas', 'COMENTAR'),
('Ver listado votantes', 'VIEW_VOTER'), ('Gestionar auditoría', 'AUDIT_MNG'), 
...
(2,1, 1, 10, 0, HASHBYTES('SHA2_256', 'PropuestaVotacion1-1-10')),
(3,1, 1, 100, 0, HASHBYTES('SHA2_256', 'PropuestaVotacion1-1-100')),

-- Votación 2: Becas Rurales (propuesta 2)
(4,2, 2, 89, 0, HASHBYTES('SHA2_256', 'PropuestaVotacion2-2-89')),
(5,2, 2, 789, 0, HASHBYTES('SHA2_256', 'PropuestaVotacion2-2-789')),
(6,2, 2, 364, 0, HASHBYTES('SHA2_256', 'PropuestaVotacion2-2-364')),

-- Votación 3: Clínicas Móviles (propuesta 3)
(7,3, 3, 1, 0, HASHBYTES('SHA2_256', 'PropuestaVotacion3-3-1')),
(8,3, 3, 10, 0, HASHBYTES('SHA2_256', 'PropuestaVotacion3-3-10')),
(9, 3,3, 100, 0, HASHBYTES('SHA2_256', 'PropuestaVotacion3-3-100')),

-- Votación 4: Reforestación (propuesta 4)
(10,4, 4, 89, 0, HASHBYTES('SHA2_256', 'PropuestaVotacion4-4-89')),
(11,4, 4, 789, 0, HASHBYTES('SHA2_256', 'PropuestaVotacion4-4-789')),
(12, 4,4, 364, 0, HASHBYTES('SHA2_256', 'PropuestaVotacion4-4-364')),

-- Votación 5: Centros de Innovación (propuesta 5)
(13, 5, 5,1, 0, HASHBYTES('SHA2_256', 'PropuestaVotacion5-5-1')),
(14, 5, 5,10, 0, HASHBYTES('SHA2_256', 'PropuestaVotacion5-5-10')),
(15, 5, 5,100, 0, HASHBYTES('SHA2_256', 'PropuestaVotacion5-5-100')),
...
DECLARE @i INT = 0;
DROP TABLE IF EXISTS #MapeoRespuestasPreguntas;
...
-- Proyecto 6 (₡100,000 - 50% - Colones costarricenses - Pago trimestral)
(6, 1, 50000, 1, 3);
